    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="bg-brand-800 hover:bg-brand-700 text-white text-xs font-bold px-4 py-2.5 rounded-xl shadow-lg shadow-brand-900/30 flex items-center gap-2"
          >
          ...
          return (
            <div
              ...
              className={`glass-panel p-5 rounded-2xl cursor-pointer transition-all border-2 flex flex-col justify-between ${
                isSelected
                  ? 'border-brand-700 bg-stone-100/40 dark:bg-stone-900/40 shadow-xl'
            ...
            >
              <div className="flex gap-4">
                ...
                <div className="space-y-1.5 flex-1 min-w-0">
                  <div className="flex items-center justify-between">
                    <span className="font-mono font-extrabold text-brand-700 dark:text-brand-400 text-xs">{style.styleNumber}</span>
                  ...
                  <div className="p-2 bg-slate-100 dark:bg-slate-800/80 rounded-lg text-xs space-y-1">
                    <div className="font-bold text-slate-700 dark:text-slate-300 flex items-center gap-1.5">
                      <Layers className="w-3.5 h-3.5 text-brand-600" /> {style.fabricSpec}
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 pt-3 border-t border-slate-200 dark:border-slate-800 flex justify-between items-center text-xs">
                ...
                <button
                  ...
                  className="font-bold text-brand-700 dark:text-brand-400 hover:underline flex items-center gap-1"
                >
                  View BOM ratio →
                </button>
              </div>
      ...
      <div className="glass-panel rounded-2xl p-6 space-y-6">
        <div className="flex justify-between items-center border-b border-slate-200 dark:border-slate-800 pb-4">
          <div>
            <div className="text-xs font-bold text-brand-700 dark:text-brand-400 uppercase font-mono">{selectedStyle.styleNumber} Specification Sheet</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-xs">
          <div className="space-y-3">
            <h4 className="font-extrabold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
              <Layers className="w-4 h-4 text-brand-600" /> Fabric Specifications
            </h4>
          ...
          <div className="space-y-3">
            <h4 className="font-extrabold uppercase tracking-wider text-slate-400 flex items-center gap-1.5">
              <Palette className="w-4 h-4 text-brand-600" /> Accessories & Trims List
            </h4>
