          ...
          <div
            ...
            className={`p-4 rounded-xl border transition-all flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 ${
              item.read
                ...
                : 'bg-blue-50/40 dark:bg-blue-950/30 border-blue-200 dark:border-blue-900/60 shadow-sm'
            }`}
          >
            <div className="flex items-start gap-3">
              ...
              <div className="space-y-1">
                <div className="flex items-center gap-2">
                  ...
                  {!item.read && <span className="w-2 h-2 rounded-full bg-blue-500 animate-ping" />}
                </div>
            ...
            <div className="flex items-center gap-2 text-xs">
              <span className="badge bg-emerald-100 text-emerald-800 dark:bg-emerald-950 dark:text-emerald-300 font-mono text-[10px] flex items-center gap-1">
                <Mail className="w-3 h-3" /> Email Sent
              </span>
              <span className="badge bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 font-mono text-[10px] flex items-center gap-1">
