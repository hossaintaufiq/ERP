          ...
          return (
            <div
              ...
              className={`glass-panel p-4 rounded-xl cursor-pointer transition-all border-2 ${
                isSelected
                  ? 'border-blue-600 bg-blue-50/50 dark:bg-blue-950/40 shadow-lg'
            ...
            >
              ...
              <div className="mt-4 pt-3 border-t border-slate-200/60 dark:border-slate-800 flex justify-between text-xs">
                ...
                <div className="text-right">
                  ...
                  <div className="font-bold text-emerald-600 dark:text-emerald-400">${(b.totalRevenue / 1000).toFixed(0)}k</div>
                </div>
              </div>
            </div>
          );
      ...
      <div className="glass-panel rounded-2xl p-6 space-y-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 pb-4 border-b border-slate-200 dark:border-slate-800">
          <div className="flex items-center gap-4">
            <img src={selectedBuyer.logo} alt={selectedBuyer.name} className="w-16 h-16 rounded-2xl object-cover ring-2 ring-blue-500/40" />
            <div>
          ...
          <div className="flex items-center gap-1 bg-slate-100 dark:bg-slate-800 p-1 rounded-xl text-xs font-semibold">
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all ${
                activeTab === 'info' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-100'
              }`}
            >
              Buyer Information
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all ${
                activeTab === 'orders' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-100'
              }`}
            >
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all ${
                activeTab === 'payments' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-100'
              }`}
            >
              Payment History
            </button>
            <button
              ...
              className={`px-3 py-1.5 rounded-lg transition-all ${
                activeTab === 'docs' ? 'bg-white dark:bg-slate-900 text-blue-600 shadow' : 'text-slate-500 hover:text-slate-900 dark:hover:text-slate-100'
              }`}
            >
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-xl space-y-3">
                ...
                <div className="text-xs text-slate-600 dark:text-slate-300 space-y-1">
                  <div className="flex items-center gap-2"><Mail className="w-3.5 h-3.5 text-blue-500" /> {selectedBuyer.email}</div>
                  <div className="flex items-center gap-2"><Phone className="w-3.5 h-3.5 text-blue-500" /> {selectedBuyer.phone}</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-xl space-y-3 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-bold text-emerald-600">${selectedBuyer.totalRevenue.toLocaleString()}</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-slate-500">Outstanding Balance:</span>
                  <span className="font-bold text-rose-500">${selectedBuyer.outstandingBalance.toLocaleString()}</span>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-3">
            ...
            <div className="p-4 bg-slate-50 dark:bg-slate-800/60 rounded-xl space-y-3 text-xs">
              ...
              <div className="flex justify-between items-center py-2">
                <span className="font-mono font-bold text-blue-600">#SO-1023</span>
                <span>Premium Slim Fit Polo Shirt (STL-9920)</span>
                <span>5,000 Pcs</span>
                <span className="badge bg-blue-100 text-blue-800 dark:bg-blue-950 dark:text-blue-300 font-bold">In Production</span>
              </div>
              <div className="flex justify-between items-center py-2">
                <span className="font-mono font-bold text-blue-600">#SO-1027</span>
                <span>Washed Denim Oversized Jacket (STL-8801)</span>
                <span>3,000 Pcs</span>
                <span className="badge bg-purple-100 text-purple-800 dark:bg-purple-950 dark:text-purple-300 font-bold">QC Inspection</span>
              </div>
            </div>
          </div>
        )}
