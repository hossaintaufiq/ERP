    ...
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="glass-panel p-5 rounded-2xl space-y-2">
          ...
          <div className="text-2xl font-black text-rose-600 dark:text-rose-400">$412,000</div>
        ...
        <div className="glass-panel p-5 rounded-2xl space-y-2">
          ...
          <div className="text-2xl font-black text-blue-600 dark:text-blue-400">$320,000</div>
        ...
        <div className="glass-panel p-5 rounded-2xl space-y-2">
          ...
          <div className="text-2xl font-black text-amber-600 dark:text-amber-400">$145,000</div>
          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="border-b border-slate-200 dark:border-slate-800 text-slate-400 uppercase text-[10px] font-extrabold">
                ...
                <th className="py-2.5 px-3 text-right font-black text-emerald-600">Net Profit Margin</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800 font-medium">
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                ...
                <td className="py-3 px-3 text-right font-mono font-black text-emerald-600 text-sm">+$6,700 (29.7%)</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-800/40">
                ...
                <td className="py-3 px-3 text-right font-mono font-black text-emerald-600 text-sm">+$8,000 (25.0%)</td>
              </tr>
            </tbody>
          </table>
        </div>
