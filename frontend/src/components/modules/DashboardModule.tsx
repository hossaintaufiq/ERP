    ...
    <div className="space-y-6 animate-fade-up duration-200">
      ...
      <div className="hero-banner">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 relative z-10">
          <div>
            <p className="module-eyebrow mb-2">Operations Center</p>
            <h2 className="text-2xl font-bold tracking-tight text-stone-100">Factory Executive Dashboard</h2>
          ...
          <div className="flex items-center gap-2">
            <button onClick={() => setActiveModule('bom')} className="btn-primary text-xs">
              <Calculator className="w-4 h-4" />
              BOM Calculator
            </button>
            <button onClick={() => setActiveModule('production_planning')} className="btn-secondary text-xs !bg-stone-800 !border-stone-700 !text-stone-200 hover:!bg-stone-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="glass-panel p-5 space-y-3">
          <div className="flex justify-between items-start">
            ...
            <span className="kpi-icon"><Boxes className="w-4 h-4" /></span>
          </div>
        ...
        <div className="glass-panel p-5 space-y-3 border-status-danger/20">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-semibold text-status-danger uppercase tracking-wider">Delayed Orders</span>
            <span className="kpi-icon"><AlertTriangle className="w-4 h-4" /></span>
          </div>
        ...
        <div className="glass-panel p-5 space-y-3">
          <div className="flex justify-between items-start">
            ...
            <span className="kpi-icon"><DollarSign className="w-4 h-4" /></span>
          </div>
        ...
        <div className="glass-panel p-5 space-y-3 bg-stone-50 dark:bg-stone-900/80">
          <div className="flex justify-between items-start">
            <span className="text-[11px] font-semibold text-stone-500 uppercase tracking-wider">Net Profit</span>
            <span className="kpi-icon bg-brand-800 text-white dark:bg-brand-700">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="hero-banner !p-5">
            <p className="module-eyebrow !text-stone-400 mb-2">Platform</p>
            <h4 className="font-semibold text-base text-stone-100">20-Module ERP Suite</h4>
